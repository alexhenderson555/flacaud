...
import {
  ...
  ListMusic, Mic2, Sliders, Disc, ListOrdered, Play, Pause, Wand2, Compass, History,
...
const NAV = [
  ...
  { id: 'nav-set-browser', title: 'Set Browser', keywords: 'dj mix youtube soundcloud tracklist search radio', icon: Compass, path: '/set-browser' },
